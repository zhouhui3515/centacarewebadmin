...
<center>
	...
	<h2 style="float:center">Client Information Table</h2></center> <br>
	...
	<table id="datatable" class="display" cellspacing="0" width="100%">
				        <thead>
				            <tr>
				                ...
				                <th>Date of Birth</th>
				                <th>File Number</th>
				                <th>Download Complete Support Plan</th>
				        ...
				        <tbody>
							...
							<?php
								...
								$query = "SELECT * FROM ClientBasicInformation";
										...
										<tr>
							                ...
							                <td> 
							            <form id="sampleForm" name="sampleForm" method="POST" action="detailinfo.php">
	<input type="hidden" name="fileno" id="fileno" value= "<?php echo $row['FileNo'] ?>"> 
